...
// DashboardController eredita da BaseController, così ottiene le notifiche, header e menu
public class DashboardController extends BaseController {

	// CLASSE WRAPPER INTERNA
    // Serve "impacchettare" in un unico oggetto le informazioni di un'Attività e del Progetto a cui 
    // appartiene, per mostrarle facilmente nella Tabella Generale della Dashboard.
    ...
    public void initialize() {
        ...
        if (currentUser != null) {
            ...
            //Formatta graficamente l'aspetto delle Notifiche a tendina
    ...
    // SETUP DELLA TABELLA
    // Questo metodo definisce come i dati vengono disegnati dentro le celle della tabella
